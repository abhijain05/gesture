...
function resolvePage(raw: string): Page | null {
  ...
  for (const [alias, page] of Object.entries(ID_ALIAS)) {
    ...
    if (
      aliasStripped.startsWith(keyStripped) ||
      keyStripped.startsWith(aliasStripped)
    )
      return page;
  }
  return null;
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {isMobile && (
            <span style={{ fontWeight: 700, fontSize: 14 }}>Fiori</span>
          )}
        </div>
        ...
        <>
          ...
          >
            ...
            {isActive && (
              ...
              >
                🤚 Gesture:{" "}
                {gesture === "NONE" ? "—" : gesture.replace(/_/g, " ")} · {fps}{" "}
                FPS
              </div>
            )}
          </nav>
          ...
          >
            ...
            >
              ...
              <StatusRow
                ...
                valueColor={isActive ? "#107e3e" : "#6a6d70"}
              />
              {isActive && (
                <>
                  <StatusRow
